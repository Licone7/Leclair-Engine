...
import static Leclair.memory.Allocator.UtilityFB2;
...
public class GLRenderer implements Renderer {
        ...
        for (final Mesh mesh : Mesh.getMeshes()) {
            if (mesh.initialized == true) {
                ...
                glVertexAttrib4fv(4, UtilityFB2.put(0, mesh.material.getAmbientColor().getR())
                        .put(1, mesh.material.getAmbientColor().getG()).put(2, mesh.material.getAmbientColor().getB())
                        .put(3, mesh.material.getAmbientColor().getA()));
                glVertexAttrib4fv(6, UtilityFB2.put(0, mesh.material.getDiffuseColor().getR())
                        .put(1, mesh.material.getDiffuseColor().getG()).put(2, mesh.material.getDiffuseColor().getB())
                        .put(3, mesh.material.getDiffuseColor().getA()));
                glVertexAttrib4fv(8, UtilityFB2.put(0, mesh.material.getSpecularColor().getR())
                        .put(1, mesh.material.getSpecularColor().getG()).put(2, mesh.material.getSpecularColor().getB())
    ...
    public void addShader(final Shader shader, final int program, final int index) {
        ...
        case GraphicsInfo.VERTEX_SHADER:
            ...
            lengths.clear();
            break;
        case GraphicsInfo.FRAGMENT_SHADER:
            ...
            lengths.clear();
            break;
        case GraphicsInfo.COMPUTE_SHADER:
            break;
        default:
